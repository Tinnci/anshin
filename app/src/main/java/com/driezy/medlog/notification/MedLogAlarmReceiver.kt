    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            "ACTION_TAKEN" -> {
                ...
                alarmScheduler.cancelFollowUpAlarm(medId, timeIndex)
                goAsyncSafe {
                    ...
                    if (existingLog?.status == LogStatus.TAKEN) return@goAsyncSafe
            ...
            "ACTION_SKIP" -> {
                ...
                goAsyncSafe {
                    ...
                    if (existingLog?.status == LogStatus.SKIPPED) return@goAsyncSafe
