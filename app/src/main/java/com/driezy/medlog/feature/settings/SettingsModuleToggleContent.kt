...
@Composable
internal fun ModuleToggleList(uiState: SettingsUiState, onAction: (SettingsUiAction) -> Unit) {
    ...
    Column(
        ...
        SettingsModuleToggleCard(
            ...
            onCheckedChange = { onAction(SettingsUiAction.SetSymptomDiary(it)) },
        ...
        SettingsModuleToggleCard(
            ...
            onCheckedChange = { onAction(SettingsUiAction.SetDrugDatabase(it)) },
            showSubtitle = layoutProfile.showSupportingText,
        )
        HorizontalDivider()
        SettingsModuleToggleCard(
            ...
            onCheckedChange = { onAction(SettingsUiAction.SetHealthModule(it)) },
            showSubtitle = layoutProfile.showSupportingText,
        )
        HorizontalDivider()
        SettingsModuleToggleCard(
            ...
            onCheckedChange = { onAction(SettingsUiAction.SetDrugInteraction(it)) },
            showSubtitle = layoutProfile.showSupportingText,
        )
    }
}
