...
@Composable
internal fun SettingsHomeModulesContent(uiState: SettingsUiState, onAction: (SettingsUiAction) -> Unit) {
    SettingsCard(
        ...
        ArchivedMedicationsRow(
            ...
            onRestore = { onAction(SettingsUiAction.UnarchiveMedication(it)) },
        )
    }
}
