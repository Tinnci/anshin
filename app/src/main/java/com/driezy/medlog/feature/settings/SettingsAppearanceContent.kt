...
internal fun SettingsAppearanceContent(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(MedLogSpacing.Medium)) {
        ...
        DisplaySettingsCard(uiState = uiState, onAction = onAction)
        TodaySettingsCard(
            uiState = uiState,
            onAction = onAction,
            showSupportingText = profile.showSupportingText,
        ...
        Row(
            ...
            modes.forEachIndexed { index, (mode, label) ->
                ToggleButton(
                    ...
                    onCheckedChange = { onAction(SettingsUiAction.SetThemeMode(mode)) },
                    modifier = Modifier
                        .weight(1f)
            ...
            LazyRow(
                ...
                items(ThemePalette.entries, key = { it.name }) { palette ->
                    ThemePaletteChip(
                        ...
                        onClick = { onAction(SettingsUiAction.SetThemePalette(palette)) },
                    )
                }
            }
        }
...
@Composable
private fun DisplaySettingsCard(uiState: SettingsUiState, onAction: (SettingsUiAction) -> Unit) {
    SettingsCard(
        ...
        Column(
            ...
            DisplayOptionGroup(
                ...
                onSelected = { onAction(SettingsUiAction.SetFontMode(it)) },
            )
            DisplayOptionGroup(
                ...
                onSelected = { onAction(SettingsUiAction.SetAppTextScale(it)) },
            )
            DisplayOptionGroup(
                ...
                onSelected = { onAction(SettingsUiAction.SetUiDensityScale(it)) },
            )
        }
    }
}
    ...
    SettingsCard(
        ...
        Column(
            ...
            DisplayOptionGroup(
                ...
                onSelected = { onAction(SettingsUiAction.SetHomeHeroStyle(it)) },
            )
        }
        SettingsSwitchRow(
            ...
            onCheckedChange = { onAction(SettingsUiAction.SetAutoCollapse(it)) },
