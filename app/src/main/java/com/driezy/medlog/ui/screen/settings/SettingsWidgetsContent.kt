            ...
            WidgetPreviewPager(
                items = listOf(
                    WidgetPreviewItem(
                        ...
                        onAdd = { requestWidget(MedLogWidgetReceiver::class.java) },
                    ),
                    WidgetPreviewItem(
                        ...
                        canPin = canPin,
                        showActions = uiState.widgetShowActions,
                        onAdd = { requestWidget(NextDoseWidgetReceiver::class.java) },
                    ),
                    WidgetPreviewItem(
                        ...
                        sizes = listOf("2×2", "4×2"),
                        canPin = canPin,
                        onAdd = { requestWidget(StreakWidgetReceiver::class.java) },
                    ),
                ),
            )
        }
